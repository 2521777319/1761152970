    ...
    def get_content_list(self):
        while True:
            ...
            for li in li_list:
                ...
                item["evaluate"] = li.xpath("./p/a[1]/span[2]/text()")[0] if len(
li.xpath("./p/a[1]/span[2]")) > 0 else None
                item["price"] = li.xpath("./p/a[2]/span[1]/text()")[0] if len(
li.xpath("./p/a[2]/span[1]")) > 0 else None
